...
<template>
    ...
    <section>
        ...
        <ul class="mt-1">
            <li class="py-2">
                ...
                <ul class="flex mb-2">
                    <li>
                        <a href="#" class="bg-blue-600 text-white px-2 py-1 mr-1 text-sm rounded">Live</a>
                    </li>
                    <li>
                        <a href="#" class="bg-blue-600 text-white px-2 py-1 mr-1 text-sm rounded">Code</a>
                    </li>
                </ul>
                <p class="text-xs">
    ...
    <section>
        ...
        <ul class="mt-2">
            <li class="pt-2">
                <p class="flex justify-between text-sm"><strong class="text-base">Company Name</strong>2019-2021</p>
            ...
            <li class="pt-2">
                <p class="flex justify-between text-sm"><strong class="text-base">Company Name</strong>2014-2019</p>
                <p class="flex justify-between text-base">Job title<small>location</small></p>
                <p class="text-justify text-xs">Lorem ipsum dolor sit amet consectetur adipisicing elit.
